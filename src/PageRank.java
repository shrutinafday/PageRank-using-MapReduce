...
public class PageRank {
  ...
  public static void main(String[] args) throws Exception {
      ...
      mainObject.MergeFiles(input_tmp , input);
  ...
  private Integer readCountFromFile (String filepath, Configuration conf) throws IOException
  {
      ...
      try {
          ...
          //This will generate file names -0001 to -0999
          for (int i=0; i<=999; i++){
  ...
  private void MergeFiles(String input, String output) throws  IOException {
      ...
      try {
          ...
          //This will generate file names -00001 to -00999
          for (int i=0; i<=999; i++){
